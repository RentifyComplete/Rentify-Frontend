...
import 'dart:convert';
import 'widgets/tenant_agreement_card.dart';
    ...
    return Column(
      ...
      children: [
        ...
        if (hasActiveBooking) ...[
          ...
          // ── 1. Owner-Generated Agreement (Download Only) ──
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 4.w),
            child: FutureBuilder<String?>(
              ...
              builder: (context, snapshot) {
                ...
                return Container(
                  padding: EdgeInsets.all(3.w),
                  decoration: BoxDecoration(
                    color: hasAgreement ? Colors.green.shade50 : Colors.grey.shade50,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: hasAgreement ? Colors.green.shade200 : Colors.grey.shade200,
                    ),
                  ),
                  child: Row(
                    children: [
                      Icon(
                        Icons.description,
                        color: hasAgreement ? Colors.green.shade700 : Colors.grey,
                        size: 6.w,
                      ),
                      SizedBox(width: 3.w),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              hasAgreement
                                  ? 'Generated by landlord'
                                  : 'Not yet generated by landlord',
                              style: TextStyle(
                                fontSize: 9.sp,
                                color: hasAgreement
...
// ── 2. Tenant Upload Their Signed Agreement ──
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 4.w),
            child: TenantAgreementCard(
              propertyId: _activeBooking!['propertyId']?.toString() ?? '',
              backendService: _backendService,
              baseUrl: 'https://rentify-backend-cdaj.onrender.com',
            ),
          ),
          SizedBox(height: 3.h),
        ],
